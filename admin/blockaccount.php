...
<table width="720" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#333333">
  <tr>
    <td bgcolor="#333333">
  <br>
      <table width="600"  border="0" align="center" bgcolor="#333333">
        <tr>
          <td colspan="2" class="big_title"><div align="left">
            <p align="center">              Are you sure you want to block this account:</p>
        ...
        <tr align="center">
          <td width="300" class="big_title"><a href="doblockaccount.php?id=<? echo $_POST['id'];?>&type=<? echo $_POST['type']; ?>&username=<?echo $_POST['username'];?>">Block Account</a> </td>
