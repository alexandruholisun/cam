    ...
    <td align="center" valign="middle" bgcolor="#333333"><form action="login.php" method="post" enctype="application/x-www-form-urlencoded" name="form1">
      ...
      <table width="720" border="0" align="center" bgcolor="#333333">
        ...
        <tr>
          ...
          <td colspan="2"><p align="center"><span class="error"><?php if ( isset($errorMsg) && $errorMsg!=""){ echo $errorMsg; } ?></span>
        ...
        <tr>
          ...
          <td width="260" align="right" valign="top" class="form_definitions"><div align="right">Username:</div></td>

          <td width="450" align="left" valign="top"><input name="accountUser" type="text" id="accountUser" value="<? echo $_GET[user];?>" size="24" maxlength="24"></td>
        ...
        <tr>
          ...
          <td align="left" valign="top"><INPUT TYPE="image" SRC="images/submit.png" HEIGHT="30" WIDTH="173" BORDER="0" ALT="">            <div align="left"></div></td>
