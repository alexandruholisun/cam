...
$result=mysql_query("SELECT * from favorites WHERE model='$_GET[model]' LIMIT 1");
	...
	$result2=mysql_query("SELECT phone,email,emailnotify,smsnotify from chatusers WHERE user='$member' LIMIT 1");
		...
		$message = "$_GET[model] started broadcasting today at: $nown <br>Press here to log in to your account<br>$siteurl/login.php<br>Thanks!<br>The Webmaster <br>This is an automated response, please do not reply!"; 
